...
?>
    ...
    <script type='text/javascript'>
      ...
      function drawChart() {
		...
		var data_r_w = google.visualization.arrayToDataTable([['Label', 'Value'],k_r_w]);
